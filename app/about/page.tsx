  ...
  return (
    <main className="about-page">
      ...
      <section className="about-intro about-shell">
        <video className="about-intro-media" src={images.cafeVideo} autoPlay loop muted playsInline aria-label="Davangiri Loni Dosa cafe video" />
      ...
      <section className="about-founders about-shell"><img src={images.storefront} alt="Davangiri Loni Dosa storefront and cafe interior" /><div><p className="eyebrow">The minds behind</p><h2>The <em>Magic</em></h2><p>Built by people who believe South Indian food deserves a modern stage without losing its soul. Our founders bring hospitality, detail, and an instinct for making every guest feel at home.</p><div className="founder-note"><h3>Mr. Subhash Umarane</h3><p>Co-founder and managing director, bringing thoughtful leadership and a deep love for the rituals that make a cafe feel like family.</p></div></div></section>
