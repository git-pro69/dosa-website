  ...
  return (
    <main className="overflow-hidden">
      ...
      <section className="house-note">
        ...
        <p className="house-note-copy">Our cafe is our <span>temple.</span><br />Our customers are <span>gods.</span><br />And what we serve is <span>prasad</span>.</p>
        <div className="house-note-detail"><span className="eyebrow">The house note</span><p>From a first tawa at dawn to the last filter coffee of the evening, everything here is made with patience, generosity, and a very particular love for ghee.</p></div>
      </section>

      <section id="story" className="statement story-statement">
