...
export default function MenuPage() {
  ...
  return <main className="menu-page">
    ...
    <section className="menu-reference-hero" aria-label="Davangiri Loni Dosa introduction"><img className="menu-reference-bg" src={referenceImage} alt="" aria-hidden="true" /><img className="menu-reference-art" src={leafyArtwork} alt="" aria-hidden="true" /><div className="menu-reference-copy"><h1>Warning:<br /><em>Cravings Ahead</em></h1></div></section>
