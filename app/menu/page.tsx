...
export default function MenuPage() {
  ...
  return <main className="menu-page">
    ...
    <section className="menu-video-wrap" aria-label="Davangiri Loni Dosa video"><video className="menu-video" autoPlay muted loop playsInline poster={dosa}><source src={videoUrl} type="video/mp4" />Your browser does not support video playback.</video><div className="menu-video-overlay" aria-hidden="true" /><p className="menu-video-caption">Authentic loni dosa · made with love</p></section>
    <section className="menu-intro section-shell"><p className="eyebrow">The Davangiri table</p><h1>Simple, warm,<br /><em>unforgettable.</em></h1><p>We are here to serve you authentic Loni Dosa. Enjoy our delicious food with your friends and family — crisp from the tawa, generous with the butter, and always made fresh for you.</p><a className="hero-button" href="#menu-list">Explore the menu <ArrowDownRight size={18} /></a></section>
